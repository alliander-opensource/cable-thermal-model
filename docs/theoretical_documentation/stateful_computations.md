...
Refer to [this example calculation](./../examples/example_calculation.ipynb#stateful-computations) for example usage and
to the [API Documentation](./../api_reference/cable_thermal_model/model/schemas/state_schemas.md) for information about the `State` object.
