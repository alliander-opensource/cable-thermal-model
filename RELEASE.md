...
the Cable Thermal Model. In short, this means we follow a structure of
...
there is a built-in command to update the version of your package, called uv
version. We use this to update our versions, and also follow the structure that
uv provides to increment our versions using premajor, preminor, etc. Check
